      ...
      begin
        ...
        begin
          ...
          begin
            ...
            SetLength(sSecurityKey, 32);
            SecurityKey := PWideChar(sSecurityKey);
            ZeroMemory(SecurityKey, Length(sSecurityKey)*SizeOf(WideChar));
            {+.}
...
begin
  ...
  if {+}(OperationResult = CLOUD_OPERATION_OK) and (PutResult.Count > 1){+.} then
  begin
